...
```bash
node dist/cli.js [options] <input_file.v> <folder>
```
...
4.  **Serialization**: Writes the layout results into the binary format, compresses with snappy, and generates the `circuit.data` file.